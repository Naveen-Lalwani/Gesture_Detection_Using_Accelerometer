...
public class Model {
    ...
    public String trainDataFilepath = "trainData1.arff";
    private String testDataFilepath = "testData1.arff";
    private Classifier model;
    private Context context;

    /*
     * Gestures selected: 1, L, N, 2
     */
    public String[] outputClasses = {"1", "L", "N", "2"};
    ...
    public Model(Context context) {
        ...
        featureNames.put("XMean", "numeric");
        featureNames.put("ZMean", "numeric");
        featureNames.put("XMax", "numeric");
        featureNames.put("ZMax", "numeric");
        featureNames.put("XPercentile", "numeric");
        featureNames.put("ZPercentile", "numeric");
    }
                                ...
                                DescriptiveStatistics gtime, DescriptiveStatistics gx, DescriptiveStatistics gy, DescriptiveStatistics gz)
    {
        ...
        data[2] = ax.getMax();
        data[3] = az.getMax();
        data[4] = ax.getPercentile(90);
        data[5] = az.getPercentile(90);
        return data;
    }
    ...
    public void train(boolean isAddTrainingSamples) {
        ...
        // Selecting Random Forest as classifier.
